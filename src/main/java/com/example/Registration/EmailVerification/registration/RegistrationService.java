...
import com.example.Registration.EmailVerification.appuser.AppUser;
import com.example.Registration.EmailVerification.appuser.AppUserRole;
import com.example.Registration.EmailVerification.appuser.AppUserService;
import com.example.Registration.EmailVerification.email.EmailSender;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        boolean isValidEmail = emailValidation.test(request.getEmail());//to validate the email when the request send is successful
        if (!isValidEmail) {
